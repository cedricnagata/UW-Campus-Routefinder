...
public class Point implements Comparable<Point> {
    ...
    /**
     * @param other Point the coordinate to compare the distance of
     *        'this' to.
     * @return the distance between the points of 'this' and 'other'
     */
     ...
     *
     * @param other Point object to compare 'this' to
     * @return positive if this is greater than other, negative if this is less than other,
